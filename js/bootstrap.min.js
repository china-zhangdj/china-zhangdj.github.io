...
function() {
    ...
    s = (function(t) {
        ...
        h = function() {
            ...
            e.prototype._removeElement = function(e) {
                ...
                r.supportsTransitionEnd() && t(e).hasClass(l.FADE) ? t(e).one(r.TRANSITION_END,
                function(t) {
    ...
    function(t) {
        ...
        l = function() {
            ...
            return e.prototype.toggle = function() {
                ...
                if (i) {
                    ...
                    if (o) {
                        if ("radio" === o.type) if (o.checked && t(this._element).hasClass(r.ACTIVE)) e = !1;
                        else {
        ...
        }).on(a.FOCUS_BLUR_DATA_API, s.DATA_TOGGLE_CARROT,
        function(e) {
    ...
    function(t) {
        ...
        _ = function() {
            ...
            l.prototype.to = function(e) {
                ...
                if (! (e > this._items.length - 1 || e < 0)) if (this._isSliding) t(this._element).one(d.SLID,
                function() {
                    return n.to(e)
                });
                else {
            ...
            l.prototype._addEventListeners = function() {
                var e = this;
                this._config.keyboard && t(this._element).on(d.KEYDOWN,
                function(t) {
                    return e._keydown(t)
                }),
                "hover" === this._config.pause && (t(this._element).on(d.MOUSEENTER,
                function(t) {
                    return e.pause(t)
                }).on(d.MOUSELEAVE,
                function(t) {
    ...
    function(t) {
        ...
        p = function() {
            ...
            a._jQueryInterface = function(e) {
                return this.each(function() {
                    ...
                    o = n.data(s),
                    r = t.extend({},
                    l, n.data(), "object" === (void 0 === e ? "undefined": i(e)) && e);
        ...
        t(document).on(c.CLICK_DATA_API, f.DATA_TOGGLE,
        function(e) { / input | textarea / i.test(e.target.tagName) || e.preventDefault();
            var n = t(this),
    ...
    function(t) {
        ...
        g = function() {
            ...
            l.prototype._getPlacement = function() {
                ...
                return e.hasClass(u.DROPUP) || this._config.placement === f.TOP ? (n = f.TOP, t(this._menu).hasClass(u.MENURIGHT) && (n = f.TOPEND)) : t(this._menu).hasClass(u.MENURIGHT) && (n = f.BOTTOMEND),
                n
            },
        ...
        t(document).on(c.KEYDOWN_DATA_API, d.DATA_TOGGLE, g._dataApiKeydownHandler).on(c.KEYDOWN_DATA_API, d.MENU, g._dataApiKeydownHandler).on(c.CLICK_DATA_API + " " + c.KEYUP_DATA_API, g._clearMenus).on(c.CLICK_DATA_API, d.DATA_TOGGLE,
        function(e) {
            e.preventDefault(),
            e.stopPropagation(),
            g._jQueryInterface.call(t(this), "toggle")
        }).on(c.CLICK_DATA_API, d.FORM_CHILD,
        function(t) {
            t.stopPropagation()
        }),
        ...
        f = function() {
            ...
            a.prototype.show = function(e) {
                ...
                if (!this._isTransitioning) {
                    ...
                    this._isShown || i.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), t(document.body).addClass(u.OPEN), this._setEscapeEvent(), this._setResizeEvent(), t(this._element).on(c.CLICK_DISMISS, d.DATA_DISMISS,
                    function(t) {
                        return n.hide(t)
            ...
            a.prototype.hide = function(e) {
                ...
                if (e && e.preventDefault(), !this._isTransitioning && this._isShown) {
                    ...
                    this._isShown && !o.isDefaultPrevented() && (this._isShown = !1, this._setEscapeEvent(), this._setResizeEvent(), t(document).off(c.FOCUSIN), t(this._element).removeClass(u.SHOW), t(this._element).off(c.CLICK_DISMISS), t(this._dialog).off(c.MOUSEDOWN_DISMISS), i ? t(this._element).one(r.TRANSITION_END,
                    function(t) {
            ...
            a.prototype._showBackdrop = function(e) {
                ...
                if (this._isShown && this._config.backdrop) {
                    ...
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = u.BACKDROP, i && t(this._backdrop).addClass(i), t(this._backdrop).appendTo(document.body), t(this._element).on(c.CLICK_DISMISS,
                    function(t) {
            ...
            a._jQueryInterface = function(e, n) {
                return this.each(function() {
                    ...
                    r = t.extend({},
                    a.Default, t(this).data(), "object" === (void 0 === e ? "undefined": i(e)) && e);
    ...
    function(t) {
        ...
        f = function() {
            function s(e, i) {
                ...
                t(this._scrollElement).on(h.SCROLL,
                function(t) {
                    return o._process(t)
                }),
                this.refresh(),
    ...
    function(t) {
        ...
        t(document).on(i.CLICK_DATA_API, a.DATA_TOGGLE,
        function(e) {
            e.preventDefault(),
    ...
    function(t) {
        ...
        m = function() {
            ...
            a.prototype._getConfig = function(n) {
                return (n = t.extend({},
                this.constructor.Default, t(this.element).data(), n)).delay && "number" == typeof n.delay && (n.delay = {
                    show: n.delay,
                    hide: n.delay
                }),
